...
/**
 * This function contains Custom CSS that will be Loaded in the Theme Header.
 */
function enliven_initialize_header() {
...
add_action('wp_head', 'enliven_initialize_header');
